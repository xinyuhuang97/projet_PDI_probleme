...
function model_Bard_Nananukul(filename,mtz=true)
    ...
    @variable(m, z0t[1:nb_t],lower_bound = 0) # variable de nb de vehicules partent a partir du producteur
    ...
    # same as in Resolution_heuristique
    # contraintes (5)(6) pour dire le stock du revendeurs est inferieur à son capacoté de stockage
    for t in 1:nb_t
        for ind in 2:nb_clients+1
